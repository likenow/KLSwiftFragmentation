...
extension RecommendViewModel {
    ...
    func requestData(_ finishCallback : @escaping () -> ()) {
        ...
        // 3.请求第一部分的推荐数据
        dGroup.enter()
        NetworkTool.requestData(.get, URLString: "http://capi.douyucdn.cn/api/v1/getbigDataRoom", parameters: paramters) { (result) in
        ...
        // 4.请求第二部分的颜值数据
        dGroup.enter()
        NetworkTool.requestData(.get, URLString: "http://capi.douyucdn.cn/api/v1/getVerticalRoom", parameters: paramters) { (result) in
...
extension RecommendViewModel {
    ...
    func requestData(_ finishCallBack: @escaping () -> ()) {
        ...
        dGroup.enter()
        loadAnchorData(method: .get, URLString: "http://capi.douyucdn.cn/api/v1/getHotCate", parameters: parameters) {
            dGroup.leave()
        }
